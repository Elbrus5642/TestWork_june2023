...
class Contact:
    ...
    # Удобный метод для записи контакта в файл
    def to_str(self):
...
class PhoneBook:
    def __init__(self, path: str):
        ...
        self.phone_list = []
        self.open()
        # Функция open сразу, при открытии теле справочника, заполняет лист с номерами  -  создаёт список контактов
    ...
    def change(self, index: int, name: str, phone: str, comment: str):
        ...
        comment = comment if comment != '' else self.comment_list[index].comment
